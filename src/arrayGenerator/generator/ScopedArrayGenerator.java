...
public abstract class ScopedArrayGenerator<T> implements ArrayGenerator<T> {
    ...
    /**
     * The scope of tis generator.
     */
    private Scope<T> scope;

    /**
     * Create a generator with the specified scope.
     * @param scope the scope of the generator.
     */
    ...
    /**
     * Get this generator's scope.
     * @return this generator's scope.
     */
