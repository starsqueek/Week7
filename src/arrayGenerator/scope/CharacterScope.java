...
/**
 * An implementation of an {@link arrayGenerator.scope.AlphabetScope} for characters.
 *
 * @author Hugh Osborne
...
public class CharacterScope extends AlphabetScope<Character> {
     ...
     * It would be better to redefine this to take its character set from the {@link java.util.Locale}.
     */
    ...
    /**
     * If no arrayGenerator.scope is specified, use the default alphabet.
     */
    ...
    /**
     * Specify the arrayGenerator.scope by means of a String.
     *
     * @param alphabet the alphabet to be used for this arrayGenerator.scope.
     */
